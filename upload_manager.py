...
class Master:
	...
	def start(self):
		...
		while True:
			...
			sql = "select id from MusicSrc where m_status in (%s,%s) order by priority desc,is_tme desc,id,sig_count limit 500" % (g_status["match_first"],g_status["sig_fail"])
